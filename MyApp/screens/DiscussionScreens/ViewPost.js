  ...
  const handleGetComments = () => {
    for (var i = 0; i < 3; i++) {
      ...
      comments.push(
          ...
          <Comment user="@noob1" comment="You cannot declare a specific border directly on the TextInput unless multiline is enabled (For example borderLeftWidth will not work unless multiline={true} is enabled but borderWidth will work), but you can just wrap the TextInput in a View and give it a border." />
