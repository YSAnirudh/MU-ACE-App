  ...
  return (
    <View style={styles().comm}>
      <View style={drawerStyles().postPic}>
        <View>
        <Avatar.Image source={require('../assets/logo2.png')} size={45}/>
        </View>
        <View>
          <Caption style={drawerStyles().postCaption}>{user}</Caption>
          <View >
        <Text style={drawerStyles().postedComment}>{comment}</Text>
      </View>
        </View>
      </View>
